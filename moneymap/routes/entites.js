...
db.open(function(err, db) {
    if(!err) {
        ...
        db.collection('entites', {safe:true}, function(err, collection) {
            if (err) {
                console.log("The 'entites' collection doesn't exist. Creating it with sample data...");
                populateDB();
            }
        });
    }
...
var populateDB = function() {
    ...
    db.collection('entites', function(err, collection) {
        collection.insert(entites, {safe:true}, function(err, result) {});
    });
